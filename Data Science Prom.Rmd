...
# Ex:
# If education_cd高中以上 的 OR = 0.7 (p < 0.01)，代表高學歷者住在風險區的勝算 少 30%。
# If having_house_type_cd=自有 的 OR = 1.5 (p < 0.05)，代表有房者住在風險區的勝算 高 50%。
# If b_age 的 OR = 1.02，代表年齡每增加 1 歲，住在風險區的勝算增加 2%。
# -----------------------------
results %>%
